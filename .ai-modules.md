...
### `src/core/detection/meatball_detector.py` (46 lines)
**Role:** Detects cars with meatball (repairs required) flag

**Key Logic:**
- Checks `session_flags & irsdk.Flags.repair` per car
- Filters out pace car, cars with negative laps_completed, NotInWorld cars, and cars on pit road
