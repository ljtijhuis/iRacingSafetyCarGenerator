...
**Documentation updates — check if any of these need updating:**
- `.ai-context.md` — if adding new patterns or conventions
- `ARCHITECTURE.md` — if changing system design or workflows
- `.ai-modules.md` — if adding new modules or changing module responsibilities
- `README.md` — if changing user-facing features or setup instructions
- `docs/RACING_CONCEPTS.md` — if adding new racing concepts or terminology
